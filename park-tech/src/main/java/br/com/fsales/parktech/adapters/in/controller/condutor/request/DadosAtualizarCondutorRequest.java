...
public record DadosAtualizarCondutorRequest(@NotBlank String id, @Schema(name = "nome", example = "Marcos Andre")
		...
		@Schema(name = "numeroHabilitacao", example = "02888820071")
		@Size(min = 10, max = 11) @Pattern(regexp = "[0-9]+") String numeroHabilitacao,
