...
public record VeiculoRequest(@Schema(name = "modelo", example = "Virtus Higline") @NotEmpty String modelo,
		...
		@Schema(name = "condutor", implementation = Condutor.class) @NotNull VeiculoRequest.Condutor condutor) {
	public record Condutor(@Schema(name = "idCondutor", example = "653fae059451cb68c8572974") @NotEmpty String id) {
	}
}
